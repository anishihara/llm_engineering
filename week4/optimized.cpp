...
int64_t max_subarray_sum(size_t n, uint64_t seed, int min_val, int max_val) {
    LCG lcg(seed);
...
int64_t total_max_subarray_sum(size_t n, uint64_t initial_seed, int min_val, int max_val) {
    int64_t total_sum = 0;
